...
from Akame.config import ARQ_API_KEY
from Akame.config import BOT_NAME as bn
from Akame.config import DURATION_LIMIT
from Akame.config import UPDATES_CHANNEL as updateschannel
from Akame.config import que
from Akame.config import SOURCE_CODE,ASSISTANT_NAME,PROJECT_NAME,SUPPORT_GROUP,BOT_USERNAME, OWNER
from Akame.function.admins import admins as a
from Akame.helpers.admins import get_administrators
from Akame.helpers.channelmusic import get_chat_id
from Akame.helpers.errors import DurationLimitError
from Akame.helpers.decorators import errors
from Akame.helpers.decorators import authorized_users_only
from Akame.helpers.filters import command, other_filters
from Akame.helpers.gets import get_file_name
from Akame.services.callsmusic import callsmusic
from Akame.services.callsmusic.callsmusic import client as USER
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/AkameSupportGroup"),
                    InlineKeyboardButton("⛑ Channel", url="https://t.me/AkameProjets"),
                ],
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/AkameSupportGroup"),
                    InlineKeyboardButton("⛑ Channel", url="https://t.me/Akames"),
                ],
                [InlineKeyboardButton(text="🗑 Close", callback_data="cls")],
            ]
        )
        ...
        try:
            ...
            while j < 5:
                ...
                toxxt += f" └ ⚡ __Powered by Akame Music Project__\n\n"
...
async def deezer(client: Client, message_: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton(text="⛑ Channel", url="https://t.me/Akames")],
        ]
    )
...
async def lol_cb(b, cb):
    ...
    keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/AkameSupportGroup"),
                    InlineKeyboardButton("🛡️ Channel", url="https://t.me/Akames"),
                ],
                [InlineKeyboardButton(text="🗑 Close", callback_data="cls")],
            ]
        )
